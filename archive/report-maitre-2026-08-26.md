# 🇰🇷 Voyage Corée du Sud 2026 — Rapport maître archivé

> Archive intégrale de la dernière version monolithique, conservée lors de la migration vers la documentation thématique.
...
> **État vols : 🟢 horaires cohérents / aucune anomalie importante détectée**
...
| 🏠 Retour final au Québec | **9 novembre 2026** |
| ✈️ Air Canada | ✅ **AXOQWM** |
...
| 🌙 Croisière | ✅ **26 oct. — 47,66 $ payé** |
| 🇰🇷 DMZ | ✅ **27 oct. — 0 $ déboursé** |
...
> **1 h 38 de correspondance à YVR**

🟢 **Cohérent actuellement.**

---

# 3. ✈️ Retour — 8/9 novembre
...
# 4. 🔎 Politique de suivi des vols du rapport maître

À partir de maintenant, **chaque fois que tu me demanderas de régénérer le rapport maître**, je ferai d'abord une vérification fraîche de :

**AC303 → AC63 → AC64 → AC314**

Je comparerai notamment :
...
Le rapport contiendra ensuite la **date du dernier contrôle** et les changements détectés.

---

# 5. Philosophie du voyage

Le séjour demeure volontairement lent et flexible.

> **matin tranquille → brunch/dîner → exploration → souper → soirée**

Les réservations servent de points d'ancrage; elles ne transforment pas les vacances en projet Jira.

Priorités musicales :

> **punk → hardcore → metal → rock alternatif → indie**

La K-pop demeure hors périmètre et ne possède aucun SLA.
...
|---|---|---|
| **23 oct.** | ✈️ YUL → YVR — AC303 | 🟢 |
| **23 oct.** | ✈️ YVR → ICN — AC63 | 🟢 |
...
| **1 nov.** | 🚄 Séoul → Busan | 🟡 |
| **2 nov.** | Busan | 🟢 |
| **3 nov.** | Busan / Gwangalli soirée | 🟢 |
| **4 nov.** | Bloc flexible | 🟢 |
| **5–7 nov.** | Libre | 🟢 |
| **8 nov.** | ✈️ ICN → YVR — AC64 | 🟢 |
| **9 nov.** | ✈️ YVR → YUL — AC314 | 🟢 |
| **9 nov.** | 🏠 Retour au Québec | 🟢 |

---

# 7. ✈️ Air Canada — financement
...
|---|---:|---|
| Hongdae principal | **593,34 $** | 🟡 12 oct. |
...
Retour à Séoul demeure l'option de référence, sans empêcher une troisième destination.
...
Crédit Airbnb utilisé.

---

# 12. 🚄 KTX / transport interurbain
...
|---|---:|
| Séoul → Busan | **75 $** |
| Retour vers Séoul / interurbain | **75 $** |

Réservation du premier trajet :

> 🔔 **30 septembre — 18 h**

Départ visé le 1er novembre :

> **11 h–13 h**

---

# 13. 🚇 Transport local Corée
...
Métro, bus et transports publics courants sont inclus.

Les taxis restent discrétionnaires.

---

# 14. 🚍🚇 Transport vers YUL

Plan :

> **Brossard → REM → métro → Palais des congrès → navette Air Canada → YUL**

Retour inverse le 9 novembre.

Provision :

# **30 $**

Tâches Google Agenda :

> **15 septembre 9 h — réserver l'aller**
> **30 septembre 9 h — réserver le retour**
...
Comprend repas, cafés, snacks et boissons courantes.

Bars/grosses soirées → budget discrétionnaire.
...
Économie vs provision initiale de 250 $ :
...
Assurance collective suffisante.
...
en plus de la nourriture, des transports, des hébergements et de l'interurbain déjà provisionnés.

---

# 22. 🎉 Utilisation de la marge

Les 797,12 $ servent essentiellement à :
...
> **~1 000 $ déjà disponible**
> **+ ~500 $ supplémentaire prévu**

# **~1 500 $ de réserve**

Filet de sécurité, pas extension du budget.
...
Économie potentielle d'intérêts :
...
Séparé des 5 000 $ du voyage.

## Épicerie enfants

| Achat | Période | Budget |
|---|---|---:|
| **15 oct.** | **15 → 29 oct.** | **400 $** |
| **29 oct.** | **29 oct. → 12 nov.** | **400 $** |
| **TOTAL** | | **800 $** |

Le deuxième 400 $ peut être modulé selon les besoins réels des enfants.
...
> **2–3 fois/semaine — coût et disponibilité à déterminer**

---

# 29. 📆 Échéancier principal
...
| **20 janv.** | ✈️ Air Canada — 275,94 $ |

---

# 30. Tableau de progression
...
Financièrement, le plafond demeure :
